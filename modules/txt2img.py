...
def txt2img_create_processing(
    ...
    p = processing.StableDiffusionProcessingTxt2Img(
        ...
        batch_size=shared.generation_batch_size,
        n_iter=shared.generation_n_iter,
        cfg_scale=shared.generation_cfg_scale,
        width=shared.generation_width,
        height=shared.generation_height,
        enable_hr=enable_hr,
        denoising_strength=shared.generation_denoising_strength,
        hr_scale=shared.generation_hr_scale,
        hr_upscaler=shared.generation_hr_upscaler,
        hr_second_pass_steps=shared.generation_hr_second_pass_steps,
        hr_resize_x=shared.generation_hr_resize_x,
        hr_resize_y=shared.generation_hr_resize_y,
