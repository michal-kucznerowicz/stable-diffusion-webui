...
def create_output_panel(tabname, outdir):
    ...
    if tabname != "extras":
        ...
        with gr.Group():
            res.infotext = gr.HTML(elem_id=f'html_info_{tabname}', elem_classes="infotext", visible=False)
            res.html_log = gr.HTML(elem_id=f'html_log_{tabname}', elem_classes="html-log", visible=False)
